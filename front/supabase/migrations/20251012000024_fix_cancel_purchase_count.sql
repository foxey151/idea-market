-- Migration: 20251012000024_fix_cancel_purchase_count
-- Description: 購入取消時に支払い済みだった場合のみ購入回数を減らす
-- 作成日: 2025-10-12

-- =================================================================
-- restore_idea_on_sold_delete関数を修正（支払い済みだった場合のみ購入回数を減らす）
-- =================================================================
...
-- コメント更新
COMMENT ON FUNCTION public.restore_idea_on_sold_delete() IS 'soldテーブルからレコードが削除されたときに、独占契約の場合はstatusをsoldoutからpublishedに戻し、通常購入で支払い済みだった場合はpurchase_countを減らす';

-- =================================================================
-- cancel_purchase関数を修正（支払い済みだった場合のみ購入回数を減らす）
-- =================================================================
