-- Migration: 20250911000001_extensions_and_enums
-- Description: PostgreSQL拡張機能とENUM型の初期設定（整理版）
-- 作成日: 2025-09-11
...
-- 価格設定
DO $$ BEGIN
    CREATE TYPE public.price_enum AS ENUM ('3000', '5000', '10000', '30000', '50000');
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
