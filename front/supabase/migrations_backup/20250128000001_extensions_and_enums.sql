-- Migration: 20250128000001_extensions_and_enums
-- Description: PostgreSQL拡張機能とENUM型の初期設定
-- 作成日: 2025-01-28
...
-- ユーザーロール
DO $$ BEGIN
    CREATE TYPE public.role AS ENUM ('member', 'company', 'admin');
EXCEPTION
...
-- アイデアバージョン種別
DO $$ BEGIN
    CREATE TYPE public.version_type AS ENUM ('X', 'Y');
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
