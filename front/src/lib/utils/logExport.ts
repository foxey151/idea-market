...
export const convertLogsToCSV = (logs: LogEntry[], logType: LogType): string => {
...
// ファイル名を生成
export const generateLogFileName = (logType: LogType, startDate?: string, endDate?: string): string => {
