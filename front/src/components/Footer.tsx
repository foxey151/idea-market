        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about" className="text-muted-foreground hover:text-foreground">アイデアマーケットとは</Link></li>
              <li><Link href="/ideas" className="text-muted-foreground hover:text-foreground">アイデア一覧</Link></li>
              <li><Link href="/search" className="text-muted-foreground hover:text-foreground">アイデア検索</Link></li>
              <li><Link href="/ideas/new" className="text-muted-foreground hover:text-foreground">アイデア投稿</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/signup" className="text-muted-foreground hover:text-foreground">会員登録</Link></li>
              <li><Link href="/login" className="text-muted-foreground hover:text-foreground">ログイン</Link></li>
              <li><Link href="/profile" className="text-muted-foreground hover:text-foreground">プロフィール</Link></li>
              <li><Link href="/my/ideas" className="text-muted-foreground hover:text-foreground">投稿したアイデア</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about-ideas" className="text-muted-foreground hover:text-foreground">アイデアとは</Link></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground">法人向けサービス</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground">広告掲載について</a></li>
