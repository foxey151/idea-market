...
import { Edit, User, CreditCard } from 'lucide-react';
// MapPin は現在未使用
      ...
      {!isEditing ? (
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm mt-1">
                  {getDisplayValue(userDetails?.full_name)}
                </p>
              </div>
              <div>
                <Label className="text-sm font-medium text-muted-foreground">
                ...
                <p className="text-sm mt-1">
                  {getDisplayValue(userDetails?.email)}
                </p>
              </div>
              <div>
                <Label className="text-sm font-medium text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-sm mt-1">
                  {getDisplayValue(userDetails?.birth_date)}
                </p>
              </div>
              <div>
                <Label className="text-sm font-medium text-muted-foreground">
                ...
                <p className="text-sm mt-1">
                  {userDetails?.prefecture
                    ? formatPrefecture(userDetails.prefecture)
                    : '未設定'}
                </p>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm mt-1">
                  {getDisplayValue(userDetails?.bank_name)}
                </p>
              </div>
              <div>
                <Label className="text-sm font-medium text-muted-foreground">
                ...
                <p className="text-sm mt-1">
                  {getDisplayValue(userDetails?.branch_name)}
                </p>
              </div>
              <div>
                <Label className="text-sm font-medium text-muted-foreground">
              ...
              <div>
                ...
                <p className="text-sm mt-1">
                  {userDetails?.account_number
                    ? `****${userDetails.account_number.slice(-4)}`
                    : '未設定'}
                </p>
              </div>
              <div className="md:col-span-2">
                ...
                <p className="text-sm mt-1">
                  {getDisplayValue(userDetails?.account_holder)}
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>情報を変更して保存してください。</CardDescription>
          </CardHeader>
          <CardContent>
